...
def max_sum(self_motion_fields, neighbor_messages, w12, penalty_matrix, template_one_matrix, max_motion_x, max_motion_y):
            ...
            for point_id in range(point_number):
                ...
                if point_new in edge_points1_map:
                    ...
                    if g1_norm < epsilon and g2_norm < epsilon:
                        ...
                        w12 = 0.005
                    next_message_map[edge_points1_map[point_new], 3-d] = max_sum(motion_fields[point_id], neighbor_messages, w12, penalty_matrix, template_one_matrix, max_motion_x, max_motion_y)
